...
class Verb(models.Model):
    ...
    participio_presente = models.JSONField(max_length=255, null=True, blank=True)
    participio_passato = models.JSONField(max_length=255, null=True, blank=True)

    indicativo_presente = models.JSONField(max_length=255, null=True, blank=True)
    perfetto = models.JSONField(max_length=255, null=True, blank=True)
    indicativo_imperfetto = models.JSONField(max_length=255, null=True, blank=True)
    indicativo_passato_remoto = models.JSONField(max_length=255, null=True, blank=True)
    indicativo_futuro = models.JSONField(max_length=255, null=True, blank=True)
